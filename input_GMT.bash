...
A=WSne  #Annotation
D=-Dx1.1c/5.0c+w4.5c/0.2c+jTC #Colorbar
...
cfont="gmt set FONT_ANNOT_PRIMARY 14p,Helvetica FONT_TITLE 10p MAP_TITLE_OFFSET 0.1c MAP_ANNOT_OFFSET_PRIMARY 0.3c MAP_ANNOT_OFFSET_SECONDARY 0.1c MAP_LABEL_OFFSET 0.1c"
...
parbscale="-Cpanoply -T-2/0/0.01 -Z -Do -Qi"
